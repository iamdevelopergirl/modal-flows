    ...
    return(
        <div className="table-data-container">
            {props.responseData.map((listItem, index) => {
                return (
                    <TableDataComponent key={listItem.id} id={listItem.id} item={listItem} handleDeleteModal={props.handleDeleteModal} handleMarkUpdateModal={props.handleMarkUpdateModal}/>
                )
            })}
        </div>
    )
    ...
    return(
        <div className="data-container">
            ...
            <div className={`list-col-6`}>
                <ButtonComponent id={props.id} className="update_lead_modal_btn mark_update_btn" name="Mark Update" onClick={() => props.handleMarkUpdateModal(props.id)}/>
